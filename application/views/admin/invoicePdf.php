            ...
            <div id="details" class="clearfix">
                <div class="row">
                    <div id="client" class="col-sm-4" >
                        ...
                        <div class="phone"><?php echo $customer_info->mobile_no?></div>
                    ...
                    <div id="client" class="col-sm-4">
                        ...
                        <h2 class="name"><?php echo $shipping_info->name?></h2>
                        <div class="phone"><?php echo $shipping_info->phone?></div>
                    ...
                    <div id="client" class="col-sm-4">
                        ...
                        <div class="date"><b>Invoice Date :</b> <?php echo $order_info->order_date?></div>
                        <div class="date"><b>Due Date :</b> <?php echo date('Y-m-d', strtotime($order_info->order_date. ' + 7 day'))?></div>
                        <div>Thank you!</div>
                    </div>
                </div>
            </div>
